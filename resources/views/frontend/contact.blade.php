                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                        ...
                        <div class="p-5 rounded contact-form">
                            <div class="mb-4">
                                <input type="text" class="form-control border-0 py-3" required placeholder="Your Name">
                            </div>
                            <div class="mb-4">
                                {!! Form::select(
                                    'country',
                                    ...
                                    '0',
                                    ['class' => 'form-control border-0 py-3', 'required' => '', 'placeholder' => 'country'],
                                ) !!}
                            </div>
                            <div class="mb-4">
                                <input type="email" class="form-control border-0 py-3" required placeholder="Your Email">
                            </div>
                            <div class="mb-4">
                                <input type="text" class="form-control border-0 py-3" required placeholder="Project">
                            </div>
                            <div class="mb-4">
                                <textarea class="w-100 form-control border-0 py-3" required rows="6" cols="10" placeholder="Message"></textarea>
                            </div>
